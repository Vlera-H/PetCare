...
//     setError('');
//     try {
//       const [p, t, v] = await Promise.all([fetchPets(), fetchCareTasks(), fetchVisits()]);
//       setPets(p);
//       setCareTasks(t);
//       setVisits(v);
//       setUseDemo(false);
...
//     try {
//       if (!useDemo) await updatePet(p.id, p);
...
//     try {
//       if (!useDemo) await updateCareTask(t.id, t);
...
//     try {
//       if (!useDemo) await deleteCareTask(id);
...
//     try {
//       if (!useDemo) await updateVisit(v.id, v);
...
//     try {
//       if (!useDemo) await deleteVisit(id);
